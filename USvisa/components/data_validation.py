...
import sys
import pandas as pd
from evidently.metrics import DatasetDriftMetric  # Use DatasetDriftMetric instead of DataDriftMetric
...
class DataValidation:
    ...
    def detect_dataset_drift(self, reference_df: DataFrame, current_df: DataFrame) -> bool:
        ...
        """
        try:
            # Use DatasetDriftMetric for drift detection
            data_drift_metric = DatasetDriftMetric()

            # Create a report using the new Report class
            report = Report(metrics=[data_drift_metric])
